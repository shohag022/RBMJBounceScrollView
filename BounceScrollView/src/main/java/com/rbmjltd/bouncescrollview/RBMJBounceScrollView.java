package com.rbmjltd.bouncescrollview;
...
public class RBMJBounceScrollView extends NestedScrollView {
    ...
    public RBMJBounceScrollView(@NonNull Context context) {
        this(context, null);
    }

    public RBMJBounceScrollView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RBMJBounceScrollView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
